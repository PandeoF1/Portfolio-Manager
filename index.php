		...
		<div id="footer-div" class="footer-div">
			...
			<footer id="footer">
				<div class="roww">
					...
					<p>© PLANQUE Clément - <?php echo date("Y"); ?></p>
				</div>
			</footer>
		</div>
	</body>
...
<?php if (isset($div["login"])) {
	...
	if (isset($_POST["login"]) && isset($_POST["password"])) {
		...
		$pass = mysql_real_escape_string($_POST["password"]) . "SHFIUdhsggfiyhDSAHfgSHFIUdhsggfiyhDSAHfgSHFIUdhUdhsggfiyhDSAHfgSHFIUdhUdhsggfiyhDSAHfgFDsgfd";
		$result = $mysqli->query(
...
?>
	...
	<body>
		...
		<div style="margin-top: 3.8em; margin-left:auto; margin-right:auto; width: 71%;">
			...
			while ($row = $result->fetch_row()) {
				echo "<div class='text'>";
				echo "<p class='title'> $row[1]</p><div style='height:1px;font-size:1px;'>&nbsp;</div>";
				echo $row[2];
